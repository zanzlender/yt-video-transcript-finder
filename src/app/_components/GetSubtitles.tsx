  ...
  return (
    <>
      <div className="mx-auto w-full">
        <div className="mx-auto mb-6 flex w-full max-w-3xl flex-row items-center gap-2">
          <input
            type="text"
        ...
        <div className="flex w-full flex-col gap-2" ref={parentRef}>
          ...
          <div className="max-h-[1000px] overflow-y-auto">
            {getTranscriptMutation.isSuccess && (
              <div className="grid w-full grid-cols-1 gap-6 rounded-md border border-slate-600 bg-[#0f0024] p-2 lg:grid-cols-2">
                <PlyrVideoPlayer
                  ref={videoFrameRef}
                  source={{
                    sources: [
